...
values
  ...
  ('Dビル貸会議室4',10,'https://bc01w7-app.s3.ap-northeast-1.amazonaws.com/room_2.jpg','東京都新宿区西新宿','駅徒歩2分、○○完備 △△',False,24);
...

{
  "name": "Aビル貸会議室1",
  "capacity": 5,
  "img_url": "https://bc01w7-app.s3.ap-northeast-1.amazonaws.com/room_1.jpg",
  "address": "東京都港区三田○○",
  "description": "example 駅から徒歩3分、××、△△完備",
  "disabled": false,
